...
func (h *GroupEventHandler) AddGroupEvent(w http.ResponseWriter, r *http.Request) {
	...
	groupEvent := &models.GroupEvent{
		ID:             uuid.New(), // Generated by handler for consistency
		GroupID:        groupID,
		EventID:        req.EventID,
		AddedBy:        req.AddedBy,
		IsHierarchical: req.IsHierarchical,
		Status:         req.Status,
		AddedAt:        time.Now().UTC(), // Generated by handler for consistency
	}

	// Set default status if not provided
	if groupEvent.Status == "" {
		groupEvent.Status = string(models.EventStatusPending)
	}
...
func (h *GroupEventHandler) AddEventStatus(w http.ResponseWriter, r *http.Request) {
	...
	status := &models.GroupEventStatus{
		...
		UserID:    req.UserID,
		Status:    req.Status,
		CreatedAt: now, // Generated by handler for consistency
		UpdatedAt: now, // Generated by handler for consistency
	}
...
func (h *GroupEventHandler) UpdateEventStatus(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.repo.UpdateEventStatus(r.Context(), eventID, req.UserID, req.Status, time.Now().UTC()); err != nil {
		h.log.Error().Err(err).
			Str("event_id", eventID.String()).
			Str("user_id", req.UserID.String()).
...
func (h *GroupEventHandler) CreateInvitation(w http.ResponseWriter, r *http.Request) {
	...
	invitation := &models.GroupInvitation{
		...
		CreatedAt: time.Now().UTC(), // Generated by handler for consistency
	}
